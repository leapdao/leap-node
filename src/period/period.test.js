...
describe('Period handler', () => {
  ...
  beforeEach(() => {
    ...
    web3.eth.getTransactionReceipt = () => ({ status: '1' });
  });
  ...
  describe('failed', () => {
    ...
    beforeEach(() => {
      ...
      periodProposal = proposal({ txHash: '0xdeadbeef' });
      bridgeState = bridgeStateMock(periodProposal);
      web3.eth.getTransactionReceipt = () => Promise.resolve({ status: '0' });
    });
  ...
  test('submission successful', async () => {
    ...
    web3.eth.getTransactionReceipt = () => Promise.resolve({ status: '1' });
